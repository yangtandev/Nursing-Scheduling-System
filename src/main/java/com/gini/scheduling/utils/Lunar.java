...
public class Lunar {
	 ...
	 * System.out.println("公曆日期:"+sdf.format(cal.getTime())); Lunar lunar=new
	 * Lunar(cal); System.out.print("農曆日期:"); System.out.print(lunar.year+"年 ");
	 ...
	 * Lunar(today); System.out.println("北京時間：" +
	 * chineseDateFormat.format(today.getTime()) + "　農曆" + lunar); }
	 */
